...
MonthlyReport.for_client('ikigai_stay')
```
...
└── platform_development
    ...
    ├── monthly_reports      # 月次オペレーション分析レポート（AnalyticsAI）
...
| `MonthlyReportGeneratorService` | Claude API で仕訳データから業種別月次分析レポートを生成 |
